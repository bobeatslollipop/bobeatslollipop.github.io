...
\titleformat{\subsection}
  ...
  {0pt}
  {}
  [\vspace{-0.35em}\rule{\textwidth}{0.25pt}]
...
\newcommand{\papersep}{\vspace{0.72em}}
...
\subsection*{Manuscripts and Ongoing Projects}

\paperentry
{On Hint-Induced Answer Shifts in Chain-of-Thought Reasoning}
{Sara Ahmadian, Pranjal Awasthi, \textbf{Anxin Guo}, Kamesh Munagala, Chirag Pabbaraju, and Aravindan Vijayaraghavan. (alphabetical order)}
...
{Ruize Xu, Yi Gu, \textbf{Anxin Guo}, Tianchong Jiang, Chenxiao Yang, and Zhiyuan Li.}
{Manuscript.}
{}
\papersep
...
{\textbf{Anxin Guo}, Tianlong Huang, Chenxiao Yang, and Zhiyuan Li.}
{Manuscript.}
{}
\begin{cvitems}
  \item Demonstrated that frontier LLMs struggle to autoregressively copy strings with extreme repetition.
  ...
  \item Showed, both theoretically and empirically, that the augmented architecture can copy arbitrary strings using logarithmic width and $\log \log N$ precision.
\end{cvitems}
\papersep
...
{\textbf{Anxin Guo} and \href{https://ieor.columbia.edu/content/jingwei-li}{Jingwei Li}.}
...
{\textbf{Anxin Guo} and \href{https://users.cs.northwestern.edu/~aravindv/}{Aravindan Vijayaraghavan}.}
...
I have written three Chinese-language articles on theoretical computer science for
